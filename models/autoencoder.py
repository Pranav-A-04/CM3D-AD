...
class ConsistencyAutoEncoder(Module):
    ...
    def decode(self, x, code, num_points, flexibility=0.0, ret_traj=False):
        #batch_size = x.shape[0]
        #updated_context = torch.zeros(batch_size, self.args.latent_dim, device=x.device)
        return self.consistency.sample(x, num_points, code, point_dim=3, flexibility=flexibility, ret_traj=ret_traj)
