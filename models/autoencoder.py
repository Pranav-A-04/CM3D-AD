...
class AutoEncoder(Module):
    ...
    def decode(self, code, num_points, flexibility=0.0, ret_traj=False):
        return self.diffusion.sample(
            num_points, code, point_dim=3, flexibility=flexibility, ret_traj=ret_traj
        )
...
class ConsistencyAutoEncoder(Module):
    ...
    def decode(self, x, code, num_points, flexibility=0.0, ret_traj=False):
        return self.consistency.sample(
            x, num_points, code, point_dim=3, flexibility=flexibility, ret_traj=ret_traj
        )
